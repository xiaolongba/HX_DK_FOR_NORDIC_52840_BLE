...
![在这里插入图片描述](https://img-blog.csdnimg.cn/2020122321055017.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3hpYW9sb25nYmE=,size_16,color_FFFFFF,t_70)
...
- [红旭无线的52840 Dongle](https://item.taobao.com/item.htm?spm=a1z10.3-c-s.w4023-22232069203.13.753f3551e5TkFc&id=598472801867) 
	![在这里插入图片描述](https://img-blog.csdnimg.cn/20201223210700922.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3hpYW9sb25nYmE=,size_16,color_FFFFFF,t_70)

- 大名鼎鼎的协议分析软件[Wireshark](https://www.wireshark.org/)
	
    ![在这里插入图片描述](https://img-blog.csdnimg.cn/20201223211014317.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/20201223211031661.png)
# 烧录抓包固件
在烧录之前，我们还需要在nRF Connect for Desktop中安装nRF Connect Programmer（安装过程不表），安装后的界面如下图所示：
![在这里插入图片描述](https://img-blog.csdnimg.cn/20201223211057469.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3hpYW9sb25nYmE=,size_16,color_FFFFFF,t_70)
打开Programmer便可以对红旭的52840 Dongle进行捉包固件地烧录，其中捉包的固件在nRF Sniffer for Bluetooth LE中可以找到，如下图所示：
![在这里插入图片描述](https://img-blog.csdnimg.cn/2020122321111220.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3hpYW9sb25nYmE=,size_16,color_FFFFFF,t_70)
![在这里插入图片描述](https://img-blog.csdnimg.cn/20201223211119660.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3hpYW9sb25nYmE=,size_16,color_FFFFFF,t_70)
1. 增加抓包的固件
2. 抓包固件的路径
3. 最后装载成功后的显示
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/20201223211252798.png)
但是，此时先**暂不选择串口**，还需要按下下图红色高亮的按键进入USB DFU模式：
![在这里插入图片描述](https://img-blog.csdnimg.cn/20201223211532545.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3hpYW9sb25nYmE=,size_16,color_FFFFFF,t_70)
如果此时红灯闪亮，则说明Dongle已经进入了USB DFU模式，现在可以选中该设备并进行抓包固件的烧录；
![在这里插入图片描述](https://img-blog.csdnimg.cn/20201223212136419.gif)
如果出现下图所示界面，则说明连接Dongle成功且可以正常进行固件烧录：
![在这里插入图片描述](https://img-blog.csdnimg.cn/20201223212906177.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3hpYW9sb25nYmE=,size_16,color_FFFFFF,t_70)
1.  表示跟Dongle建立连接成功
1. 烧录抓包固件

如果上述的操作均正确且正常的话，那么最终会出现如下界面：
![在这里插入图片描述](https://img-blog.csdnimg.cn/20201223213011440.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3hpYW9sb25nYmE=,size_16,color_FFFFFF,t_70)
...
1. 在**Sniffer_Software/extcap/** 文件夹中打开CMD并安装相应的依赖包，以下是小编的路径：
	...
	![在这里插入图片描述](https://img-blog.csdnimg.cn/2020122321324346.gif)
因为小编已经安装过了，所以提示说已经安装完成；如果是第一次安装的话就会自动下载相应的依赖包；
2. 复制Nordic的捉包工具到Wireshark的文件中：

    a. 打开Wireshark软件，并选择**Help** --> **About Wireshark**
![在这里插入图片描述](https://img-blog.csdnimg.cn/20201223213551407.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3hpYW9sb25nYmE=,size_16,color_FFFFFF,t_70)
b. 选择 **“Floders”** ，并双击**Global Extcap path**就会跳到相对应的路径，并复制**Sniffer_Software/extcap/**文件夹中的内容：
![在这里插入图片描述](https://img-blog.csdnimg.cn/20201223213654491.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3hpYW9sb25nYmE=,size_16,color_FFFFFF,t_70)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/20201223221220261.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3hpYW9sb25nYmE=,size_16,color_FFFFFF,t_70)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/20201223221240521.png)
由于5.0之后的跳频算法比较复杂，小编这里不表，感兴趣的读者可以自行阅读Spec；但是，像小编这样的学渣来说，有没有办法通过输入某些值，即可算出跳频的列表呢？答案：当然是有的，这个时候就不得不祭出一个神器了，先让大伙看看效果：
![在这里插入图片描述](https://img-blog.csdnimg.cn/20201223221255726.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3hpYW9sb25nYmE=,size_16,color_FFFFFF,t_70)
红色高亮是计算出来的跳频列表，而下图是实际抓包时的数据通道列表：
![在这里插入图片描述](https://img-blog.csdnimg.cn/20201223221311825.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3hpYW9sb25nYmE=,size_16,color_FFFFFF,t_70)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/20201223221507991.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3hpYW9sb25nYmE=,size_16,color_FFFFFF,t_70)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/20201223221548383.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/2020122322173212.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3hpYW9sb25nYmE=,size_16,color_FFFFFF,t_70)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/20201223221904522.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3hpYW9sb25nYmE=,size_16,color_FFFFFF,t_70)
