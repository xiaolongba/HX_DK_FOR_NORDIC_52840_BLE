...
<info> app:                    Welcome to wireless-tech measure pluse width project         
...
<info> app: nrf_drv_ppi_init is 0

<info> app: nrf_drv_ppi_channel_alloc is 0

<info> app: nrf_drv_ppi_channel_assign is 0

<info> app: nrf_drv_ppi_channel_enable is 0

<info> app: nrf_drv_timer_init is 0

<info> app: pluse width is 3 us

<info> app: nrf_drv_pwm_init is 0

<info> app: nrf_drv_pwm_simple_playback is 0

<info> app: pluse width is 200 us

<info> app: pluse width is 400 us

<info> app: pluse width is 600 us

<info> app: pluse width is 800 us
...
从上面的测试结果可以看出，精确度可达至us级，贼准、Perfect！！！
