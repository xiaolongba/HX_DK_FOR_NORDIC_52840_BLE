...
从以上我们分析的结果可知，要想Nordic 52840的硬件定时器工作起来，就必须要<code>使能HCLK</code>-><code>选择工作模式</code>-><code>输入COUT、START、STOP、CLEA、CAPTURE、COMPARE中的任意一个信号</code>
